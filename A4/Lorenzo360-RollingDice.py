...
if __name__=="__main__":
    parser = argparse.ArgumentParser(description="Generate N random sequences with the same length and "
                                                 "approximately the same letter frequencies as in the input file.")
    add_args(parser)
