...
Students of the class shall work on five assignments and---finally---a team project. The assignments are generally described in README files in the subdirectories A'n'; submission is generally done via git/GitHub.
...
Feel free to discuss via Pull request comments (in particular, assignment specific stuff) or GitHub issues for all more general things. Don't forget to mention the people you want to address (e.g. @mtw for me or @TBIAPBC/APBC2021 for all).
